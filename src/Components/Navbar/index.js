    ...
    render() {
        return (
            <Navigation className="white"
                alignLinks="right"
                brand={<a className="brand-logo brand-margin" href='/'><img className="logo-size-nit" src={"https://www.noticebard.com/wp-content/uploads/2020/01/NITK-Surathkal.png"} alt="NITKKRLOGO"/></a>}
                id="mobile-nav"
                fixed={true}
                ...
                >
                    ...
                    <a className="organizingLink" href="/aboutnitk">ABOUT NITK</a>
